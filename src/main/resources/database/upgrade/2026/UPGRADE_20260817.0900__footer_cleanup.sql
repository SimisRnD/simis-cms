...
--
-- 1. Restructure the logo/Follow-Us row into three sibling columns -- Logo, Follow Us (with the
--    social media icons underneath it), and Copyright -- matching the sibling-column layout of
--    the About Us / Featured Solutions / Information For / Site Links row above it. Also removes
--    the "Subscribe to Our News" button (a plain "Subscribe" link now lives under About Us
--    instead -- see the table_of_contents update below), the Privacy Policy link, and the Terms
--    of Use link -- both of the latter are now redundant with Site Links.
