 ...
 * @created 9/25/18 10:02 AM
 */
public class ResumeMedicineCommand {

  private static Log LOG = LogFactory.getLog(ResumeMedicineCommand.class);
  ...
  /**
   * Resume the medicine reminders
   *
   * @param medicine
   * @return
   * @throws DataException
   */
  public static boolean resumeMedicine(Medicine medicine, long userId) throws DataException {
    ...
    return MedicineRepository.markAsResumed(medicine);
  }
}
