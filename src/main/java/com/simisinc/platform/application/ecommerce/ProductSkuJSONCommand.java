 ...
 * @created 3/17/19 7:12 PM
 */
public class ProductSkuJSONCommand {

  private static Log LOG = LogFactory.getLog(ProductSkuJSONCommand.class);

  public static String createJSONString(ProductSku record) {
  ...
  public static void populateFromJSONString(ProductSku record, String jsonValue) throws SQLException {
