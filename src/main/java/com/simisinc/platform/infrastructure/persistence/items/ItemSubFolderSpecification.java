...
/**
 * Properties for querying objects from the item sub-folder repository
 *
 * @author matt rajkowski
 * @created 4/19/2021 1:00 PM
 */
public class ItemSubFolderSpecification extends Entity {
  ...
  public ItemSubFolderSpecification() {
  }
