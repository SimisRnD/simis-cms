 ...
 * @created 3/14/21 2:38 PM
 */
public class ProductDescriptionWidget extends GenericWidget {

  static final long serialVersionUID = -8484048371911908893L;

  static String JSP = "/ecommerce/product-description.jsp";
  ...
  public WidgetContext execute(WidgetContext context) {
    ...
    if (product == null || StringUtils.isBlank(product.getDescription())) {
      LOG.warn("Product description was not found for: " + uniqueId);
      return context;
    }
