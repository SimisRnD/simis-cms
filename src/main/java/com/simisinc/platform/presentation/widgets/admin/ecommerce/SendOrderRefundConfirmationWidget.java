 ...
 */
public class SendOrderRefundConfirmationWidget extends GenericWidget {

  static final long serialVersionUID = -8484048371911908893L;

  static String JSP = "/admin/send-order-refund-confirmation.jsp";
  ...
  public WidgetContext post(WidgetContext context) throws InvocationTargetException, IllegalAccessException {
    ...
    context.addSharedRequestValue("orderManagementMessage", "The refund confirmation was sent");
