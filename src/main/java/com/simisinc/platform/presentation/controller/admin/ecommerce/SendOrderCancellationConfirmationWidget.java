 ...
 * @created 11/20/19 6:23 PM
 */
public class SendOrderCancellationConfirmationWidget extends GenericWidget {

  static final long serialVersionUID = -8484048371911908893L;

  static String JSP = "/admin/send-order-cancellation-confirmation.jsp";
  ...
  public WidgetContext execute(WidgetContext context) {
    ...
    // See if the order has been canceled for
  ...
  public WidgetContext post(WidgetContext context) throws InvocationTargetException, IllegalAccessException {
    ...
    context.addSharedRequestValue("orderManagementMessage", "The order cancellation confirmation was sent");
