  ...
  <div class="full-container">
    <div class="grid-x grid-margin-x callout box">
      ...
      <div class="small-2 cell">
        <img id="imageUrlPreview" src="<c:out value="${blogPost.imageUrl}"/>" class="u-maxh-50 u-maxw-150"/>
      </div>
    ...
    <div class="grid-x grid-margin-x callout box">
      ...
      <div class="small-2 cell">
        <img id="shareImageUrlPreview" src="<c:out value="${blogPost.shareImageUrl}"/>" class="u-maxh-50 u-maxw-150"/>
      </div>
      <div class="small-2 cell text-right">
        <a class="button small primary radius no-gap" data-open="imageBrowserReveal"
