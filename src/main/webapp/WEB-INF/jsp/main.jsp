        ...
        <div class="off-canvas position-left reveal-for-medium admin-menu hide-for-print" style="z-index: 1005 !important; padding-bottom: 50px" id="offCanvas" data-off-canvas>
          ...
          <c:if test="${userSession.hasRole('admin')}">
            <ul class="vertical menu">
              ...
              <li<c:if test="${fn:startsWith(pageRenderInfo.name, '/admin/integrations')}"> class="is-active"</c:if>><a href="${ctx}/admin/integrations"><i class="${font:far()} fa-key fa-fw"></i> <span>Integrations</span></a></li>
