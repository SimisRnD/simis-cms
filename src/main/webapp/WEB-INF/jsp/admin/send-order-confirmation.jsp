...
<form method="post" id="sendOrderConfirmationForm">
...
<script nonce="${cspNonce}">
  function sendOrderConfirmation() {
    ...
    if (confirm('Send an order confirmation e-mail?')) {
      document.getElementById("sendOrderConfirmationButton").disabled = true;
      return true;
    }
    return false;
  }
  ...
  document.addEventListener('DOMContentLoaded', function () {
    var form = document.getElementById('sendOrderConfirmationForm');
    if (form) {
