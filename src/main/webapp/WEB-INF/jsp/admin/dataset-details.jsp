...
<p class="help-text page-help">Edit the dataset's display Name and Description shown on the Datasets list and other admin views -- these are informational labels and don't affect syncing or field mapping.</p>
