...
<div class="reveal small" id="formReveal${widgetContext.uniqueId}" data-reveal data-close-on-click="false" role="dialog" aria-modal="true" aria-labelledby="subFolderFormRevealTitle${widgetContext.uniqueId}">
