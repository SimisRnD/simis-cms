...
<form method="post" id="sendOrderRefundConfirmationForm">
...
<script nonce="${cspNonce}">
  function sendOrderRefundConfirmation() {
    ...
    if (confirm('Send a refund confirmation e-mail?')) {
      document.getElementById("sendOrderRefundConfirmationButton").disabled = true;
      return true;
    }
    return false;
  }
  ...
  document.addEventListener('DOMContentLoaded', function () {
    var form = document.getElementById('sendOrderRefundConfirmationForm');
    if (form) {
      form.addEventListener('submit', function (event) {
        if (!sendOrderRefundConfirmation()) {
