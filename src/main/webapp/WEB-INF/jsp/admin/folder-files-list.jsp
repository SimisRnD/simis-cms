...
<c:if test="${(userSession.hasRole('admin') || userSession.hasRole('content-manager'))}">
  <div class="reveal small" id="fileFormReveal" role="dialog" aria-modal="true" aria-labelledby="formTitle" data-reveal data-close-on-esc="false" data-close-on-click="false" data-animation-in="slide-in-down fast">
