...
<script src="${ctx}/javascript/jspreadsheet-4.7.3/jspreadsheet.min.js"></script>
<link rel="stylesheet" media="screen" href="${ctx}/javascript/jspreadsheet-4.7.3/jspreadsheet.css">
<script src="${ctx}/javascript/jsuites-4.4.2/jsuites.min.js"></script>
<link rel="stylesheet" media="screen" href="${ctx}/javascript/jsuites-4.4.2/jsuites.css">
