      ...
      <tr>
        ...
        <td nowrap>
          ...
          <c:if test="${siteProperty.name eq 'site.logo'}">
            <p class="help-text" id="siteLogoHelpText">The site's primary, full-color logo -- shown in the header, the confirmation dialog (if enabled), and used as the logo image in outgoing emails. Which of the three logo variants on this page actually appears in the header and menu depends on the Logo color setting on the Theme Settings page.</p>
          </c:if>
          <c:if test="${siteProperty.name eq 'site.logo.white'}">
            <p class="help-text" id="siteLogoWhiteHelpText">An all-white version of the logo, for use against dark backgrounds. Shown instead of the full-color logo depending on the Logo color setting on the Theme Settings page. It is also used automatically as the dark-mode logo, whichever variant Logo color selects for light mode; when it's left blank, the light-mode logo is reused in dark mode.</p>
          </c:if>
          <c:if test="${siteProperty.name eq 'site.logo.mixed'}">
            <p class="help-text" id="siteLogoMixedHelpText">A mixed-color logo variant. Shown instead of the full-color logo depending on the Logo color setting on the Theme Settings page.</p>
          </c:if>
