  ...
  <tbody>
    ...
    <tr>
      <td nowrap="true">
        ...
        <a aria-label="Delete ${fn:escapeXml(record.ipAddress)}" href="#" data-confirm-post="Are you sure you want to delete <c:out value="${record.ipAddress}" />?" data-post-url="${widgetContext.uri}?command=delete&widget=${widgetContext.uniqueId}&token=${userSession.formToken}&blockedIPListId=${record.id}"><i aria-hidden="true" class="fa fa-remove"></i></a>
      </td>
