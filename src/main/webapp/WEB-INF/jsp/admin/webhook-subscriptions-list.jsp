...
<p class="help-text">Webhook subscriptions deliver a signed HTTP POST to an external URL when a selected event happens. The signing secret is shown once, right after it's created or rotated -- store it in the receiving system's webhook configuration.</p>
