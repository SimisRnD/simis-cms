      ...
      <tr>
        ...
        <td>
          <select name="columnMapping${status.index}">
            ...
            <option value="summary"<c:if test="${fieldMappingsList[status.index] eq 'summary'}"> selected</c:if>>Description</option>
        ...
        <td>
          <input type="text" name="columnOptions${status.index}" placeholder="caps;uppercase;equals(&quot;value&quot;);contains(&quot;value&quot;);split(&quot;separator&quot;);skipDuplicates" value="<c:out value="${fieldOptionsList[status.index]}" />" autocomplete="off" />
        </td>
      </tr>
      </c:forEach>
