...
<div class="callout primary radius">
  ...
  <p class="u-mb-0">A column mapped to <strong>Image URL</strong> (or any other URL-type field) must contain a URL the server can reach over HTTP(S) -- there's no way here to upload binary image files directly from the source data.</p>
</div>
