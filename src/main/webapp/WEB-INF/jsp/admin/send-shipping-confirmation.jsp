...
<form method="post" id="sendShippingConfirmationForm">
...
<script nonce="${cspNonce}">
  function sendShippingConfirmation() {
    ...
    if (confirm('Send a shipping confirmation e-mail?')) {
      document.getElementById("sendShippingConfirmationButton").disabled = true;
      return true;
    }
    return false;
  }
  ...
  document.addEventListener('DOMContentLoaded', function () {
    var form = document.getElementById('sendShippingConfirmationForm');
    if (form) {
      form.addEventListener('submit', function (event) {
        if (!sendShippingConfirmation()) {
