...
<form id="form${widgetContext.uniqueId}" method="post" autocomplete="off">
  ...
  <div class="grid-x grid-margin-x">
    <div id="item-form-info-1" class="small-12 cell">
      <div class="input-group">
        <span class="input-group-label">Job/Position Title  <span class="required">*</span></span>
        <input class="input-group-field" type="text" placeholder="" name="name" value="<c:out value="${item.name}"/>" autocomplete="off" required="true">
      </div>
      <div class="input-group">
        <span class="input-group-label">Name of Organization  <span class="required">*</span></span>
        <input class="input-group-field" type="text" placeholder="" name="location" value="<c:out value="${item.location}"/>" autocomplete="off" required="true">
      </div>
      <div class="grid-x grid-margin-x">
        <div id="item-form-info-2" class="small-12 medium-6 cell">
          <div class="input-group">
        ...
        <div id="item-form-info-3" class="small-12 medium-6 cell">
          <div class="input-group">
      ...
      <div class="input-group">
        <span class="input-group-label">Optional Email Address</span>
        <input class="input-group-field" type="email" placeholder="" name="email" value="<c:out value="${item.email}"/>">
      </div>
    </div>
  </div>
