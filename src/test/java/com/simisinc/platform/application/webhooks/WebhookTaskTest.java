...
class WebhookTaskTest {
  ...
  static void startDatabase() {
    ...
    // encryption doesn't fail closed. This also proves the real signing path still works
    // end-to-end against an encrypted-at-rest secret: findById() must transparently decrypt it
    // back to "trap-secret" for AttemptWebhookDeliveryCommand to sign with, below.
