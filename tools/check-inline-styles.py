...
351 exist today across 122 templates. Migrating them is slow, and without a gate new ones
...
# Recorded 2026-09-10. May only go down. Paths are relative to src/main/webapp/WEB-INF/jsp.
BACKLOG = {
    "admin/allowed-ip-list-form.jsp": 1,
    "admin/allowed-ip-list.jsp": 3,
    "admin/audit-log-list.jsp": 2,
    "admin/blocked-ip-list-form.jsp": 1,
    "admin/blocked-ip-list.jsp": 3,
    "admin/blog-form.jsp": 1,
    "admin/blog-list.jsp": 2,
    "admin/blog-post-list.jsp": 1,
    "admin/cache-management.jsp": 1,
    "admin/calendar-event-form.jsp": 2,
    "admin/calendar-event-list.jsp": 2,
    "admin/calendar-list.jsp": 1,
    "admin/collection-categories-list.jsp": 2,
    "admin/collection-details.jsp": 1,
    "admin/collection-theme-editor.jsp": 1,
    "admin/collections-cards.jsp": 3,
    "admin/custom-fields-form-json.jsp": 3,
    "admin/database-maintenance.jsp": 3,
    "admin/dataset-configuration.jsp": 1,
    "admin/dataset-schema.jsp": 1,
    "admin/dataset-source.jsp": 1,
    "admin/dataset-sync.jsp": 2,
    "admin/datasets-list.jsp": 2,
    "admin/editorial-calendar.jsp": 2,
    "admin/folder-files-list.jsp": 1,
    "admin/folder-form.jsp": 3,
    "admin/folder-list.jsp": 1,
    "admin/form-data-list.jsp": 1,
    "admin/form-definition-form.jsp": 4,
    "admin/form-field-form.jsp": 2,
    "admin/form-fields-list.jsp": 1,
    "admin/forms.jsp": 1,
    "admin/group-form.jsp": 1,
    "admin/groups-list.jsp": 1,
    "admin/health-dashboard.jsp": 2,
    "admin/image-browser.jsp": 24,
    "admin/integration-registry.jsp": 1,
    "admin/items-list.jsp": 3,
    "admin/mfa-enrolled-roles.jsp": 1,
    "admin/newsletter-send.jsp": 10,
    "admin/page-template-gallery.jsp": 1,
    "admin/product-form.jsp": 3,
    "admin/product-list.jsp": 2,
    "admin/seo-sitemap.jsp": 4,
    "admin/site-properties-editor.jsp": 6,
    "admin/site-stats-alert-card.jsp": 4,
    "admin/site-stats-card.jsp": 1,
    "admin/site-stats-locations-map.jsp": 1,
    "admin/site-stats-recent-actions.jsp": 3,
    "admin/site-stats-table.jsp": 1,
    "admin/sitemap-editor.jsp": 13,
    "admin/sitemap.jsp": 12,
    "admin/user-details.jsp": 3,
    "admin/user-form.jsp": 5,
    "admin/users-list.jsp": 6,
    "admin/web-page-form.jsp": 2,
    "admin/web-page-list.jsp": 2,
    "admin/web-vitals.jsp": 6,
    "admin/webhook-subscription-form.jsp": 1,
    "calendar/calendar-search-results.jsp": 3,
    "calendar/full-calendar.jsp": 3,
    "calendar/small-calendar.jsp": 1,
    "cms/album-gallery.jsp": 1,
    "cms/blog-editor.jsp": 5,
    "cms/blog-post-list-cards.jsp": 1,
    "cms/blog-post-list-featured.jsp": 1,
    "cms/blog-post-list-masonry.jsp": 1,
    "cms/blog-post-list-overview.jsp": 1,
    "cms/blog-post-list.jsp": 1,
    "cms/css-editor.jsp": 5,
    "cms/file-browser.jsp": 3,
    "cms/form.jsp": 1,
    "cms/image-browser.jsp": 2,
    "cms/leaderboard.jsp": 4,
    "cms/main-menu-flat.jsp": 1,
    "cms/menu.jsp": 1,
    "cms/system-alert.jsp": 2,
    "cms/table-widget.jsp": 1,
    "cms/video-browser.jsp": 1,
    "cms/video.jsp": 4,
    "cms/web-container-xml-editor.jsp": 1,
    "cms/web-page-search-results.jsp": 3,
    "cms/web-page-xml-editor.jsp": 4,
    "cms/wiki-editor.jsp": 2,
    "cms/wiki-search-results-list.jsp": 3,
    "dashboard/metabase-embedded.jsp": 1,
    "dashboard/powerbi-embedded.jsp": 1,
    "dashboard/statistic-card-vertical.jsp": 1,
    "dashboard/statistic-card.jsp": 1,
    "ecommerce/cart.jsp": 2,
    "ecommerce/customer-payment-form.jsp": 1,
    "ecommerce/customer-shipping-method-form.jsp": 1,
    "ecommerce/product-name.jsp": 3,
    "ecommerce/shipping-address-form.jsp": 2,
    "elearning/course-list.jsp": 1,
    "embedded.jsp": 6,
    "items/categories-list.jsp": 1,
    "items/delete-item-button.jsp": 1,
    "items/directory-card-view.jsp": 1,
    "items/item-full-form.jsp": 7,
    "items/item-job-form.jsp": 1,
    "items/item-menu.jsp": 1,
    "items/items-card-view.jsp": 5,
    "items/items-category-card-view.jsp": 1,
    "items/items-integrated-search-results-list.jsp": 6,
    "items/items-list.jsp": 2,
    "layout-body-renderer.jspf": 8,
    "layout-footer-renderer.jspf": 7,
    "layout-footer-standard.jspf": 4,
    "layout-header-renderer.jspf": 9,
    "layout-header-standard.jspf": 11,
    "mailinglists/email-subscribe-inline-form.jsp": 2,
    "main.jsp": 9,
    "maps/items-map-app.jsp": 2,
    "maps/leaflet-js_map.jsp": 1,
    "maps/property-map-app.jsp": 5,
    "page_messages.jspf": 1,
    "portal/custom-fields-table.jsp": 2,
    "userProfile/my-email-preferences.jsp": 2,
    "userProfile/my-order-history.jsp": 4,
