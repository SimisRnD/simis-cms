...
# 228 across 89 when the spacing-only attributes became u-* classes. Paths are relative to
...
BACKLOG = {
    ...
    "admin/site-properties-editor.jsp": 3,
    ...
    "cms/system-alert.jsp": 1,
    "cms/table-widget.jsp": 1,
    "cms/video-browser.jsp": 1,
    "cms/video.jsp": 4,
    "cms/web-container-xml-editor.jsp": 1,
    "cms/web-page-search-results.jsp": 2,
    "cms/web-page-xml-editor.jsp": 1,
    "cms/wiki-editor.jsp": 2,
    "cms/wiki-search-results-list.jsp": 2,
